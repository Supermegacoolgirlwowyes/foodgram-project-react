# Generated by Django 3.1.14 on 2022-02-18 11:30
...
class Migration(migrations.Migration):
    ...
    replaces = [('users', '0001_initial'), ('users', '0002_auto_20220205_1302'), ('users', '0003_auto_20220218_1053')]
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='follow',
            constraint=models.CheckConstraint(check=models.Q(_negated=True, follower=django.db.models.expressions.F('following')), name='oneself subscription constraint'),
        ),
    ]
